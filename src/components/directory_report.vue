            ...
            else
            {
                ...
                for (i = 0; i < people.length; i++)
                {
                    ...
                    if ((i + 2) < people.length)
                    {
                        ...
                        columnsImg.push(                            
                            {
                                image: imgList[i + 2].image, //Second IMG in row
                                width: 150,
                                height: 150
                            })
                    }
