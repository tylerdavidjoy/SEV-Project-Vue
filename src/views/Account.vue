                                      ...
                                      <v-card-text>
                                        <v-container>
                                          <v-row>
                                            ...
                                            >
                                              <v-text-field
                                                v-model="editedLifeEvent.description"
                                            ...
                                            >
                                              ...
                                              >
                                                <template v-slot:activator="{ on, attrs }">
                                                  <v-text-field
                                                    v-model="editedLifeEvent.date"
                                                    :label="'Date: ' + editedLifeEvent.date"
                              ...
                              <v-card-text>
                                <v-list>
                                  <v-list-item
                                    ...
                                    <v-list-item-content>
                                      <v-btn icon v-on:click="editLifeEvent(LifeEvent)">
                                        <v-icon dark>
                                          mdi-pencil-outline
                                        </v-icon>
                                      </v-btn>

                                      <v-btn icon v-on:click="deleteLifeEvent(LifeEvent)">
                                        <v-icon dark>
...
export default {
  ...
  methods: {
    ...
    editLifeEvent(Event) {
      ...
      this.editedLifeEvent = Object.assign({}, Event);
      this.dialogEvents = true;
    },

    deleteLifeEvent(Event) {
      this.editedLifeEvent = this.form.LifeEvents.indexOf(Event);
      this.editedLifeEvent = Object.assign({}, Event);
    ...
    closeEvent() {
      ...
      this.$nextTick(() => {
        this.editedLifeEvent = Object.assign({}, this.defaultLifeEvent);
        this.EventsIndex = -1;
      });
    },
    ...
    saveEvent() {
      if (this.EventsIndex > -1) {
        Object.assign(this.form.LifeEvents[this.EventsIndex], this.editedLifeEvent);
      } else {
        this.form.LifeEvents.push(this.editedLifeEvent);
      }
      this.closeEvent();
    },
  },
